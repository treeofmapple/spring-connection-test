...
import com.tom.aws.awstest.image.ImageResponse;
import com.tom.aws.awstest.image.ImageService;
import com.tom.aws.awstest.image.PageImageResponse;
...
public class ImageController {
	...
	public ResponseEntity<PageImageResponse> findByObjectParams(
	...
	@GetMapping(value = "/search/id", 
			consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ImageResponse> findImageById(
	...
	public ResponseEntity<ImageResponse> uploadImageToNote(
	...
	public ResponseEntity<Resource> downloadObject(
			@PathVariable("name") String objectName
			) {
	...
	@PutMapping(value = "/edit/{name}", 
			consumes = MediaType.APPLICATION_JSON_VALUE,
			produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ImageResponse> renameObject(
			@PathVariable("name") String objectName,
			@RequestBody(required = true) 
			@NotBlank(message = "Object new name cannot be blank") 
			String newName
			) {
	...
	@PostMapping(value = "/data/generate", 
			produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<PageImageResponse> generateImages(
